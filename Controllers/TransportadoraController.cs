...
namespace TrabalhoFinalAPS.Controllers
{
    public class TransportadoraController : Controller
    {
        ...
        {
            return View(await _context.Tranportadoras.ToListAsync());
        }
        ...
        public async Task<IActionResult> Details(int? id)
        {
            ...
            var transportadora = await _context.Tranportadoras
        ...
        public async Task<IActionResult> Edit(int? id)
        {
            ...
            var transportadora = await _context.Tranportadoras.FindAsync(id);
            if (transportadora == null)
            {
                return NotFound();
            }
        ...
        {
            var transportadora = await _context.Tranportadoras.FindAsync(id);
            _context.Tranportadoras.Remove(transportadora);
            await _context.SaveChangesAsync();
            return RedirectToAction(nameof(Index));
        }
        ...
        {
            return _context.Tranportadoras.Any(e => e.Id == id);
        }
    }
}
